...
struct Recipe: Identifiable, Hashable, Codable {
  ...
  let imageURL: URL
  var generatedImage: Data?  // ADD: store generated image data
  ...
  init(from decoder: Decoder) throws {
    ...
    self.id = UUID() // Generate new UUID for decoded recipes
    self.title = try container.decode(String.self, forKey: .title)
    self.description = try container.decode(String.self, forKey: .description)
    self.cuisine = try container.decode(Cuisine.self, forKey: .cuisine)
    self.cookingTimeInMinutes = try container.decode(Int.self, forKey: .cookingTimeInMinutes)
  ...
  private enum CodingKeys: String, CodingKey {
    case id, title, description, cuisine, cookingTimeInMinutes, imageURL, ingredients, instructions
  }
  ...
  static var mockList: [Recipe] {
    [
      Recipe(
        ...
        imageURL: URL(string: "https://images.pexels.com/photos/6287527/pexels-photo-6287527.jpeg")!,
        generatedImage: nil,
        ingredients: [
          "1 pound spaghetti",
      ...
      Recipe(
        ...
        imageURL: URL(string: "https://images.pexels.com/photos/12365244/pexels-photo-12365244.jpeg")!,
        generatedImage: nil,
        ingredients: [
          "1 cup rice noodles",
      ...
      Recipe(
        ...
        imageURL: URL(string: "https://images.pexels.com/photos/5741874/pexels-photo-5741874.jpeg")!,
        generatedImage: nil,
        ingredients: [
          "1 cup quinoa",
          "2 cups water",
      ...
      Recipe(
        ...
        imageURL: URL(string: "https://images.pexels.com/photos/2098085/pexels-photo-2098085.jpeg")!,
        generatedImage: nil,
        ingredients: [
      ...
      Recipe(
        ...
        imageURL: URL(string: "https://images.pexels.com/photos/1639557/pexels-photo-1639557.jpeg")!,
        generatedImage: nil,
        ingredients: [
          "1 pound ground beef",
      ...
      Recipe(
        ...
        imageURL: URL(string: "https://images.pexels.com/photos/2474661/pexels-photo-2474661.jpeg")!,
        generatedImage: nil,
        ingredients: [
      ...
      Recipe(
        ...
        imageURL: URL(string: "https://images.pexels.com/photos/2673353/pexels-photo-2673353.jpeg")!,
        generatedImage: nil,
        ingredients: [
          "1 pound ground beef",
      ...
      Recipe(
        ...
        imageURL: URL(string: "https://images.pexels.com/photos/1146760/pexels-photo-1146760.jpeg")!,
        generatedImage: nil,
        ingredients: [
          "1 cup warm water",
      ...
      Recipe(
        ...
        cuisine: .american,
        cookingTimeInMinutes: 35,
        imageURL: URL(string: "https://images.pexels.com/photos/5175537/pexels-photo-5175537.jpeg")!,
        generatedImage: nil,
        ingredients: [
      ...
      Recipe(
        ...
        imageURL: URL(string: "https://images.pexels.com/photos/6419720/pexels-photo-6419720.jpeg")!,
        generatedImage: nil,
        ingredients: [
      ...
      Recipe(
        ...
        cuisine: .american,
        cookingTimeInMinutes: 40,
        imageURL: URL(string: "https://images.pexels.com/photos/2092507/pexels-photo-2092507.jpeg")!,
        generatedImage: nil,
        ingredients: [
          "1 pound boneless, skinless chicken breast",
      ...
      Recipe(
        ...
        cuisine: .american,
        cookingTimeInMinutes: 45,
        imageURL: URL(string: "https://images.pexels.com/photos/4969892/pexels-photo-4969892.jpeg")!,
        generatedImage: nil,
        ingredients: [
          "1 pound macaroni",
      ...
      Recipe(
        ...
        imageURL: URL(string: "https://images.pexels.com/photos/7625056/pexels-photo-7625056.jpeg")!,
        generatedImage: nil,
        ingredients: [
          "1 pound boneless, skinless chicken breast",
          "1/4 cup butter",
      ...
      Recipe(
        ...
        cuisine: .mexican,
        cookingTimeInMinutes: 35,
        imageURL: URL(string: "https://images.pexels.com/photos/2087748/pexels-photo-2087748.jpeg")!,
        generatedImage: nil,
        ingredients: [
      ...
      Recipe(
        ...
        imageURL: URL(string: "https://images.pexels.com/photos/5838239/pexels-photo-5838239.jpeg")!,
        generatedImage: nil,
        ingredients: [
      ...
      Recipe(
        ...
        imageURL: URL(string: "https://images.pexels.com/photos/675951/pexels-photo-675951.jpeg")!,
        generatedImage: nil,
        ingredients: [
          "4 veal shanks",
          "2 tablespoons olive oil",
      ...
      Recipe(
        ...
        cuisine: .american,
        cookingTimeInMinutes: 90,
        imageURL: URL(string: "https://images.pexels.com/photos/6941017/pexels-photo-6941017.jpeg")!,
        generatedImage: nil,
        ingredients: [
      ...
      Recipe(
        ...
        cuisine: .mediterranean,
        cookingTimeInMinutes: 55,
        imageURL: URL(string: "https://images.pexels.com/photos/8969237/pexels-photo-8969237.jpeg")!,
        generatedImage: nil,
        ingredients: [
      ...
      Recipe(
        ...
        cuisine: .american,
        cookingTimeInMinutes: 30,
        imageURL: URL(string: "https://images.pexels.com/photos/3219547/pexels-photo-3219547.jpeg")!,
        generatedImage: nil,
        ingredients: [
          "1 pound ground beef",
